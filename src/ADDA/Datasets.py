...
class CERRADO_MT(Dataset):

    def __init__(self, args, domain):
        super().__init__(args, domain)
        self.name = 'CERRADO_MA'
        self.folder = 'Cerrado_Biome/'
        self.data_t1_name = 'S2_MG2_2020_08_02_B12'
        self.data_t2_name = 'S2_MG2_2021_07_23_B12'
        self.reference_t1_name = 'MG2_ref_2020_2021'
        self.reference_t2_name = 'MG2_ref_2020_2021'
        self.pseudoreference_name = 'MG2_ref_2020_2021'
        self.lims = np.array([0, 1700, 0, 1440])
        self.overlap_percent = 0.96
        self.vertical_blocks = 3
        self.horizontal_blocks = 5
